...
INTERPRETATION_PROMPT_TEMPLATE = (
    ...
    "• CRITICAL: every object must become something it is NOT. A cup is never just a cup.\n"
    "  A laptop is never just a laptop. Each object must be REIMAGINED as something from\n"
    "  a completely different world — a creature, a landscape feature, a structure, a force.\n"
    "• The SCENE description must not mention what the objects actually are. If someone\n"
    "  could read your SCENE and identify 'a cup' or 'a keyboard', the scene is too literal.\n"
    ...
    "Each role must name what the object HAS BECOME, not what it is.\n"
    "Wrong: 'the cup serves as a focal point'  Right: 'the cup is a volcano crater'\n\n"
    ...
    "  c) make the viewer read the scene interpretation without being told it\n\n"
